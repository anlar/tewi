...
def create_client(
    ...
    Args:
        client_type: Type of client ('transmission' or 'qbittorrent')
    ...
    Returns:
        BaseClient instance (TransmissionClient or QBittorrentClient)
    ...
    if client_type == 'transmission':
        ...
        raise ClientError(
            ...
            f"Supported types: 'transmission', 'qbittorrent'"
        )
